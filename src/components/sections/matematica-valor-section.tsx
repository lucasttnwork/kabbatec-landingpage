          ...
          <div className="container pt-16 md:pt-24">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-7 mb-16">
                ...
                <p className="text-base sm:text-lg text-white/75 font-inter leading-relaxed">Você conhece o preço real:</p>
              </div>
                ...
                <div className="space-y-12">
                  ...
                  <div className="relative overflow-hidden rounded-[40px] border border-white/12 bg-gradient-to-br from-black/70 via-black/50 to-emerald-500/15 p-12 backdrop-blur-md shadow-[0_30px_90px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="relative space-y-6">
                      ...
                      <div className="h-px w-28 bg-gradient-to-r from-transparent via-emerald-400/60 to-transparent" />
                  ...
                  {/* Card comparativo */}
                  <div className="relative overflow-hidden rounded-[36px] border border-emerald-400/30 bg-black/45 p-10 shadow-[0_25px_80px_rgba(0,0,0,0.45)]">
                    ...
                    <div className="relative">
                      <p className="text-lg sm:text-2xl font-serif font-light text-white tracking-[0.08em]">
                        ...
                        <span className="mt-4 block text-[30px] sm:text-[36px] font-light">
                          R$ 200 mil bem investidos &gt; R$ 100 mil desperdiçados em "mais ou menos".
                        </span>
                      </p>
                    </div>
                  </div>
              ...
              {/* Texto final */}
              <div className="mt-12 text-center text-white/75 font-inter text-base italic">
