...
export const LightBar = React.forwardRef<HTMLDivElement, LightBarProps>(
  ({ className, blur = true, overflow = true }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "absolute top-0 z-50 isolate flex w-screen flex-1 items-start justify-center pointer-events-none",
