...
function Card({ className, variant = "default", ...props }: CardProps) {
  return (
    <div
      data-slot="card"
      className={cn(
        // Card base: sombra leve e radius consistente com tokens
        "bg-card text-card-foreground flex flex-col gap-6 rounded-lg border py-8 shadow-sm",
        variant === "methodology" && "border-[#E5E7EB] p-8",
        className
      )}
      {...props}
    />
